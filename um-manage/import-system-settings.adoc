...
summary: Você pode importar a configuração do sistema de um array de storage para outros arrays de storage. Essa operação em lote economiza tempo quando você precisa configurar vários arrays na rede. 
---
...
. Na caixa de diálogo Selecionar configurações, selecione *System* e clique em *Next*.
+
