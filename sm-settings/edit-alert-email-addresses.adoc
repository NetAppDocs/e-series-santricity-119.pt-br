...
summary: Você pode alterar os endereços de e-mail dos destinatários que recebem alertas por e-mail. 
---
...
. Digite um novo endereço e clique no ícone *Salvar* (marca de seleção).
+
[NOTE]
====
