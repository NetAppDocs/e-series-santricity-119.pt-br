...
summary: Para configurar autenticação para o Access Management, você pode estabelecer comunicações entre o array de storage e um servidor LDAP e, em seguida, mapear os grupos de usuários LDAP para as funções predefinidas do array. 
---
...
NOTE: Este campo aparece quando você insere uma conta de bind acima.
